        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>New Roles and Permissions</h3>
                    <p class="text-subtitle text-muted">Create a new role and select the permissions.</p>
                </div>
            </div>
        </div>        
    </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('roles.and.permissions.store') }}">
                                ...
                                <div class="form-group mandatory mb-3">
                                    ...
                                    <input type="text" class="form-control @error('role_name') is-invalid @enderror" id="role-name" name="role_name" value="{{ old('role_name') }}">
                                    @error('role_name')
                                ...
                                <div class="form-group mandatory mb-4">
                                    ...
                                    @foreach($permissions as $module => $modulePermissions)
                                        <div class="mb-4">
                                            <!-- Module Header with Dropdown -->
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <button class="btn btn-outline-primary text-start w-100" type="button" data-bs-toggle="collapse" data-bs-target="#module-{{ Str::slug($module) }}" aria-expanded="false" aria-controls="module-{{ Str::slug($module) }}">
                                                    {{ ucfirst($module) }}
                                                </button>
                                                    ...
                                                    @foreach($modulePermissions as $permission)
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input permission-checkbox module-{{ Str::slug($module) }}" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" 
